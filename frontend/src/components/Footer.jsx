    ...
    <footer className="mt-16 border-t border-slate-200 bg-white">
      <div className="container-page grid gap-8 py-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-3 max-w-md text-sm text-slate-500">A trusted campus marketplace for VSSUT students to buy, sell, chat, and exchange essentials with confidence.</p>
        </div>
        <div>
