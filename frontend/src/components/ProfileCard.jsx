    ...
    <div className="surface rounded-md p-5">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">{user.department || 'VSSUT'} · {user.location}</p>
          <p className="mt-1 flex items-center gap-1 text-sm font-semibold text-amber-600"><FaStar /> {user.rating}</p>
        </div>
      </div>
