  ...
  return (
    <>
      ...
      <section className="container-page py-12">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">{featured.map((product) => <ProductCard key={product.id} product={product} />)}</div>
      </section>
      ...
      <section className="container-page py-8">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">{latest.map((product) => <ProductCard key={product.id} product={product} />)}</div>
      </section>
      <section className="container-page py-12">
